...
- On Projects views, fields that the view already displays are skipped: a column in the table layout, or a field chip on a board card. A setting on the fields card turns this off.
